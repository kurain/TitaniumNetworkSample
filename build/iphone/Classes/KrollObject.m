...
//@interface NetworkSampleObject : NSObject
//@end

@interface NetworkSampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NetworkSampleObject class]])
		{
			for (NSString *key in [[(NetworkSampleObject*)o modules] allKeys])
			{
