...
// in simulator we redefine to format for NetworkSample Developer console
...
{\
	NSString * exceptionName = [@"org.networksample." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.networksample";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UINetworkSampleNativeItemNone = -1, 
	UINetworkSampleNativeItemSpinner = -2,
	UINetworkSampleNativeItemProgressBar = -3,
	
	UINetworkSampleNativeItemSlider = -4,
	UINetworkSampleNativeItemSwitch = -5,
	UINetworkSampleNativeItemMultiButton = -6,
	UINetworkSampleNativeItemSegmented = -7,
	
	UINetworkSampleNativeItemTextView = -8,
	UINetworkSampleNativeItemTextField = -9,
	UINetworkSampleNativeItemSearchBar = -10,
	
	UINetworkSampleNativeItemPicker = -11,
	UINetworkSampleNativeItemDatePicker = -12,
	
	UINetworkSampleNativeItemInfoLight = -13,
	UINetworkSampleNativeItemInfoDark = -14,
	
	UINetworkSampleNativeItemDisclosure = -15,
	
	UINetworkSampleNativeItemContactAdd = -16
};
